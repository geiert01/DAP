    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            if (
                ...
                if args.track:
                    wandb.log(
                        {"metrics/lipschitz_constant": lipschitz_constant},
                        step=global_step,
                    )
                    wandb.log(
            ...
            if (
                ...
                local_lipschitz_constant = compute_local_lipschitz_constant(
                    q_network, envs.envs[0]
                )
                writer.add_scalar(
                ...
                if args.track:
                    wandb.log(
                        {"metrics/local_lipschitz_constant": local_lipschitz_constant},
                        step=global_step,
                    )
