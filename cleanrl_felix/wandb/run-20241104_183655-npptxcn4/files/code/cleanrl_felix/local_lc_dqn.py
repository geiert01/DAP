...
class Args:
    ...
    start_reg_factor: float = 0.5
    end_reg_factor: float = 0.05
    regularization_fraction: float = 0.7
...
def rescale_weights_by_lipschitz(model, reg_factor):
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            if global_step > args.learning_starts and global_step % 10000 == 0:
                ...
                rescale_weights_by_lipschitz(q_network, current_reg_factor)
