...
parser.add_argument('--command', type=str, default="poetry run python cleanrl_repo/ppo.py",
...
parser.add_argument('--docker-tag', type=str, default="vwxyzjn/cleanrl_repo:latest",
