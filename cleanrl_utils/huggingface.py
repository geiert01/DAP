...
To use this model, please install the `cleanrl_repo` package with the following command:

```
pip install "cleanrl_repo[{args.exp_name}]"
...
```
    ...
    metadata["library_name"] = "cleanrl_repo"
