...
if __name__ == "__main__":
    ...
    from cleanrl_repo.td3_continuous_action_jax import Actor, QNetwork, make_env

    model_path = hf_hub_download(
        repo_id="cleanrl_repo/HalfCheetah-v4-td3_continuous_action_jax-seed1", filename="td3_continuous_action_jax.cleanrl_model"
    )
    evaluate(
        model_path,
        make_env,
