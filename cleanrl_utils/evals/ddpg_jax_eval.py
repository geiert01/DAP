...
if __name__ == "__main__":
    ...
    from cleanrl_repo.ddpg_continuous_action_jax import Actor, QNetwork, make_env

    model_path = hf_hub_download(
        repo_id="cleanrl_repo/HalfCheetah-v4-ddpg_continuous_action_jax-seed1", filename="ddpg_continuous_action_jax.cleanrl_model"
    )
    evaluate(
        model_path,
        make_env,
