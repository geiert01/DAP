...
if __name__ == "__main__":
    ...
    from cleanrl_repo.c51_jax import QNetwork, make_env

    model_path = hf_hub_download(repo_id="cleanrl_repo/CartPole-v1-c51_jax-seed1", filename="c51_jax.cleanrl_model")
    evaluate(
        model_path,
        make_env,
        "CartPole-v1",
