...
# Common arguments
parser.add_argument(
    "--wandb-project", type=str, default="vwxyzjn/gym-microrts", help="the name of wandb project (e.g. cleanrl_repo/cleanrl_repo)"
)
parser.add_argument("--run-state", type=str, default="crashed", help="the name of this experiment")

parser.add_argument("--job-queue", type=str, default="cleanrl_repo", help="the name of the job queue")
parser.add_argument(
